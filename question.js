...
function displayQuestion() {
    ...
    questionText.innerHTML = `${currentQuestionIndex + 1}. ${currentQuestion.question.replace(/\n/g, "<br>")}`;
...
function checkAnswer(selected, correct, clickedButton) {
    ...
    img.alt = "Explanatory image";
    img.className = "explanation-image";
    img.loading = "lazy";  // 👈 this one attribute is all you need
